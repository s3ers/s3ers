...
///
/// If you want to build your own matrix client type instead of using `s3ers_client::Client`, this
...
pub trait HttpClientExt: HttpClient {
    ...
    fn send_matrix_request<'a, R: OutgoingRequest + 'a>(
        ...
        self.send_customized_matrix_request(homeserver_url, request, |_| Ok(()))
    }

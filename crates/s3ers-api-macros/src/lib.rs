...
//! re-exports in s3ers-api. Also note that for technical reasons, the
//! `s3ers_api!` macro is only documented in s3ers-api, not here.
//!
//! [s3ers-api]: https://github.com/s3ers/s3ers/tree/main/s3ers-api
...
#[doc(hidden)]
#[proc_macro_derive(_FakeDeriveS3ers, attributes(s3ers_api))]
